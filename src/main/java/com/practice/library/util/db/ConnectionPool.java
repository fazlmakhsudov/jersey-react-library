package com.practice.library.util.db;
...
public class ConnectionPool {
    ...
    public ConnectionPool(Property property) {
        this.JDBC_DRIVER = property.getConfiguration("jdbcDriver");
        this.JDBC_DB_URL = property.getConfiguration("jdbcUrl") +
                "/" + property.getConfiguration("jdbcDatabase");
        this.JDBC_USER = property.getConfiguration("jdbcUserName");
        this.JDBC_PASSWORD = property.getConfiguration("jdbcPassword");
